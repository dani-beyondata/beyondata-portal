  ...
  const SHEETS = {
    ...
    'Extras': {
      ...
      toFields: r => ({
        ...
        revenue_timing:   ['at_arrival','at_checkout']
                            .includes(String(r['Revenue timing'] || '').trim())
                              ? String(r['Revenue timing']).trim() : 'at_arrival',
        purchase_timing:  ['at_booking','at_reception','unknown']
                            .includes(String(r['Purchase timing'] || '').trim())
                              ? String(r['Purchase timing']).trim() : 'unknown',
